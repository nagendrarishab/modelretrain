"""
    ...
    ./.venv/bin/python src/train/train_mobilenetv4_fasterrcnn_detect.py --epochs 2 --batch-size 16

    # CPU run - pair with a GPU run of another backbone for real parallelism (see --device):
    ./.venv/bin/python src/train/train_mobilenetv4_fasterrcnn_detect.py --epochs 2 --batch-size 4 --device cpu
"""
import argparse
import os
