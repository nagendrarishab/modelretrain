"""
    python src/run/run_camera_efficientnet_tf_detect.py --model-path models/efficientnet_tf_efficientnet_b0_detect_best.keras --source webcam
    python src/run/run_camera_efficientnet_tf_detect.py --model-path models/efficientnet_tf_efficientnet_b0_detect_best.keras --source droidcam \
...
logger = logging.getLogger("camera_efficientnet_tf_detect")
...
def main():
    ...
    parser.add_argument("--model-path", default="models/efficientnet_tf_efficientnet_b0_detect_best.keras")
    ...
    window = "Box Detector - EfficientNet RetinaNet TF (q to quit)"
    last_log_time = 0.0
